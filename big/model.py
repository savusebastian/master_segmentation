...
def get_efficientnet_unet(input_shape):
	...
	ebl7 = Concatenate(axis=3)([pool7, ebl8])
	...
	ebl6 = Concatenate(axis=3)([pool6, ebl8])
	...
	ebl5 = Concatenate(axis=3)([pool5, ebl8])
	...
	ebl4 = Concatenate(axis=3)([pool4, ebl8])
	...
	ebl3 = Concatenate(axis=3)([pool3, ebl8])
	...
	ebl2 = Concatenate(axis=3)([pool2, ebl8])
