...
if __name__ == '__main__':
	...
	for image in images:
		x_img = np.array(Image.open(f'aerial_image_dataset/training/images/{image}').resize((256, 256, 3)))
		# x_img = np.reshape(img_orig, (256, 256, 3))
		mask = np.array(Image.open(f'aerial_image_dataset/training/gt/{image}').resize((256, 256, 3)))
